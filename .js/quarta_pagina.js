...
function setup() {
    ...
    //coordinate per il tasto per tornare nella home
    xhome = 15;
    yhome = 2;
}
...
function mouseClicked(){
    ...
    if(dhome < 50){
        window.location.href = "pcto.html"; //indirizza alla paagina home
    } else if (dStart < 50){
        window.location.href = "LEG.html";  //indirizza alla pagina degli esercizi LEG
    }
}
